...
\begin{itemize}
  ...
  \item \texttt{.scope} --- for class options, this specifies whether the
    option should be treated as \texttt{local} (the standard setting) or
    \texttt{global} (read by packages from the global list); for package
    options this property has no effect
